...
<div class="LABEL">
    <h2> Ingénierie de développement d'applications informatiques </h2>
</div>
</div>
...
<div class="square">
    ...
    <div class="content">
     <h2><B>Objectifs</B></h2>
     <p>La Licence Science et Technique permet en Ingénierie de développement d'applications informatiques aux étudiants :
      <ol>
...
<div class="square">
    ...
    <div class="content">
     ...
     <p>
        <h1>✮Coordinnateur : Pr.KOUNAIDI Mohamed </h1>
        <h1>✮📧 :  m.kounaidi@uae.ac.ma</h1>
     </p>
    </div>
</div>
