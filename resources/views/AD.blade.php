...
<div class="square">
    ...
    <div class="content">
     ...
     <p>
        <h1>Coordinnateur : Pr.BAIDA Ouafae </h1>
        <h1> 📧 :  wbaida@uae.ac.ma</h1>
     </p>
    </div>
</div>
